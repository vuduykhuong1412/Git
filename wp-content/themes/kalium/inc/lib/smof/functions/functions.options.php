...
$of_options[] = array( 	'desc' 		=> 'Set maximum width for uploaded logo (Optional)<br><small><strong>NOTE</strong>: If set empty, original logo width will be applied.</small>',
...
$of_options[] = array( 	'desc' 		=> 'Set maximum width for uploaded logo in mobile devices (Optional)<br><small><strong>NOTE</strong>: If set empty, it will inherit maximum logo height from the above field.</small>',
...
$of_options[] = array( 	'name'		=> 'Main Menu Type',
						...
						'type' 		=> 'images',
						'descrs'	=> array(
							'full-bg-menu'   => 'Full Bacgkround Menu',
...
$of_options[] = array( 	'name' 		=> 'Custom Hamburger Menu Label',
						'desc' 		=> "Instead of three horizontal bars you can replace icon with text or both.<br><small>Note: If menu type is set to <strong>Standard Menu</strong> with visible links, this option is disabled.</small>",
...
$of_options[] = array( 	'desc' 		=> 'Sticky menu background opacity<br><small><strong>NOTE</strong>: Enter opacity value from scale 1 to 100.</small>',
...
$of_options[] = array( 	'desc' 		=> 'Border color opacity',
...
$of_options[] = array( 	'desc' 		=> 'Shadow color opacity',
...
$of_options[] = array( 	'desc' 		=> "Set maximum width for the uploaded logo, mostly used when you use upload retina (@2x) logo<br /><small><span class=\"note\">Note:</span> Even if you don't upload custom logo, you may set custom width for the current logo in sticky menu.</small>",
...
$of_options[] = array( 	'desc' 		=> "Image size for gallery items<br><small><span class=\"note\">Note:</span> Enter defined image size. Click <a href=\"https://codex.wordpress.org/Function_Reference/the_post_thumbnail#Thumbnail_Sizes\" target=\"_blank\">here</a> to learn more.</small>",
...
$of_options[] = array( 	'desc' 		=> "Image size for thumbnails<br><small><span class=\"note\">Note:</span> Enter defined image size. Click <a href=\"https://codex.wordpress.org/Function_Reference/the_post_thumbnail#Thumbnail_Sizes\" target=\"_blank\">here</a> to learn more.</small>",
