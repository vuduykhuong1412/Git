		...
		<h3 class="heading checkbox">  
			...
			<div class="option">
				<label>
					...
					<div class="info-of"><?php printf( __('Force show Shipping Checkout fields (to be used in conjunction with %s)', 'woocommerce-checkout-manager'), sprintf( __('Hide %s heading', 'woocommerce-checkout-manager'), __( 'Ship to a different address?', 'woocommerce' ) ) );  ?></div>
				</label>
			</div>
			<!-- .option -->
