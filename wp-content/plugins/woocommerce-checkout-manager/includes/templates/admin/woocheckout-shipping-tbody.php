...
<td class="more_toggler1">
	<input type="text" name="wccs_settings2[shipping_buttons][<?php echo $i; ?>][cow]" placeholder="MyField" value="<?php echo $options2['shipping_buttons'][$i]['cow']; ?>" <?php if ( empty($options['checkness']['abbreviation'])) { echo 'readonly="readonly"'; } ?> <?php if ( in_array($options2['shipping_buttons'][$i]['cow'], $htmlshippingabbr ) ) { echo 'readonly="readonly" style="pointer-events:none;"'; } ?> />
</td>